...
ActiveRecord::Schema.define(version: 20160120215358) do
  ...
  create_table "noticearticles", force: :cascade do |t|
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string   "skku_id",                default: "", null: false
    t.integer  "num_evaluation",         default: 0,  null: false
    t.string   "confirm_code",           default: "", null: false
